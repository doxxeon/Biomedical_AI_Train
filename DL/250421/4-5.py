...
class EncoderDecoder(Model):
    def __init__(self, hidden_dim, encoder_input_shape, decoder_input_shape, num_classes):
        ...
        self.decoder = layers.SimpleRNN(hidden_dim, return_state=True, input_shape=decoder_input_shape)
    ...
    def call(self, encoder_inputs, decoder_inputs):
        ...
        decoder_outputs, _ = self.decoder(decoder_inputs, initial_state=[encoder_state])
